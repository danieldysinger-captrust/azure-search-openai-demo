...
class ReadRetrieveReadApproach(Approach):
    ...
    template_prefix = \
"You are an intelligent assistant helping CAPTRUST employees search, sift, and summarize interal documents. " \
...
Thought: {agent_scratchpad}"""    
    ...
    CognitiveSearchToolDescription = "useful for searching through CAPTRUST internal documents"
...
class EmployeeInfoTool(CsvLookupTool):
    ...
    def __init__(self, employee_name: str):
        super().__init__(filename = "data/employeeinfo.csv", key_field = "name", name = "Employee", description = "useful for answering questions about CPATRUST interal documents")
